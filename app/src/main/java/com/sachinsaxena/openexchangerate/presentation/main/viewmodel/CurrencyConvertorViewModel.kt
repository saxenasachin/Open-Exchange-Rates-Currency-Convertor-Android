package com.sachinsaxena.openexchangerate.presentation.main.viewmodel
...
import com.sachinsaxena.openexchangerate.OpenExchangeRateApplication
import com.sachinsaxena.openexchangerate.presentation.CurrencyConvertorDataState
import com.sachinsaxena.openexchangerate.presentation.base.BaseViewModel
import com.sachinsaxena.openexchangerate.utils.NetworkUtils
...
class CurrencyConvertorViewModel @Inject constructor(
    ...
    private fun getLatestRates() {
        if (NetworkUtils.isConnected(OpenExchangeRateApplication.INSTANCE)) {
